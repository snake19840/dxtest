        ...
        + '<div class="navbar-collapse collapse" id="nav-wrap">'
          + '<ul class="nav navbar-nav navbar-right" id="nav" style="max-width:100%;">'
            ...
            + '<li class="dropdown ' + (activeClass.doc || activeClass.option || '') + '">'
              + '<a href="#" class="dropdown-toggle" data-toggle="dropdown">' + (enVersion ? 'API & Doc' : '设备管理') + '<b class="caret"></b></a>'
              + '<ul class="dropdown-menu">'
                + '<li class=""><a href="' + (loc.add || '.')  + (enVersion ? '-en.html">add' : '.jsp">设备录入') + '</a></li>'
               // + '<li class=""><a href="' + (loc.option || '.') + '/option' + (enVersion ? '-en.html">Option Manual' : '.html">配置项查找工具') + '</a></li>'
                + '<li class=""><a href="' + (loc.chaxun || '.')  + (enVersion ? '-en.html">chaxun' : '.jsp">设备查询') + '</a></li>'
              //  + '<li class=""><a href="' + (loc.xiugai || '.')  + (enVersion ? '-en.html">xiugai' : '.jsp">设备修改') + '</a></li>'
              + '</ul>'
            + '</li>'
            + '<li class="dropdown ' + (activeClass.spreadsheet || '') + '">'
              + '<a href="#" class="dropdown-toggle" data-toggle="dropdown">' + (enVersion ? 'Tool' : '运维管理') + '<b class="caret"></b></a>'
              + '<ul class="dropdown-menu">'
              + '<li><a href="' + (loc.operation || '.') + '.jsp">' + (enVersion ? 'Theme Preview' : '日常运维') + '</a></li>'
              + '<li><a href="' + (loc.operation || '.') + '.jsp">' + (enVersion ? 'Theme Preview' : '巡检管理') + '</a></li>'
              + '<li><a href="' + (loc.operation || '.') + '.jsp">' + (enVersion ? 'Theme Preview' : '扩容升级') + '</a></li>'
            ...
            */
            + '<li class="dropdown">'
              + '<a href="#" class="dropdown-toggle" data-toggle="dropdown">' + (enVersion ? 'Download' : '系统管理') + '<b class="caret"></b></a>'
              + '<ul class="dropdown-menu">'
              + '<li><a href="' + (loc.operation || '.') + '.jsp">' + (enVersion ? 'Theme Preview' : '用户管理') + '</a></li>'
              /*  
               + '<li><a href="http://echarts.baidu.com/build/echarts-' + version + '.zip"> echarts-' + version + ' (from Baidu)</a></li>'
                ...
                + '<li class="divider"></li>'
                + (enVersion ? '<li><a href="http://ecomfe.github.io/echarts/doc/changelog-en.html">Changelog</a></li>'
            ...
            + (enVersion
               ...
               : ('<li class="' + (activeClass.about || '') + '"><a href="' + (loc.about || '.') + '/about.html">知识库</a></li>')
            )
    ...
    $footer[0].innerHTML =
         '<div class="container">'
            + '<div class="row" style="padding-bottom:1px;">'
                ...
                + '<ul>'
                + '<li><a href="mailto: snake19840@126.com；" target="_blank"> 189邮箱</a></li>'
                + '</ul>'
                ...
                + '<div class="col-md-3">'
                + '<ul>'
                  + '<p>&copy; 2019 <a href="http://www.189.cn/zj/" target="_blank">China Telecom</a></p>'
                + '</ul>'
                 //   + '<p>' + (enVersion ? 'Contact Us' : '联系我们') + '</p>'
                 //   + '<ul>'
               ...
               //     + '</ul>'
                ...
                + '<div class="col-md-3 flogo">'
                    ...
                    + '<a href="javascript:void(0)" onclick="back2Top()" title="' + (enVersion ? 'Back to top' : '回到顶部') + '"><img src="'+ (loc.img || '.')+ '/asset/img/echarts-logo2_dx.png" alt="ECharts"/></a>'

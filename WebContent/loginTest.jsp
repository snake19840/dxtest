...
<!-- start: Meta -->
	...
	<!-- end: Favicon -->
		...
		<style type="text/css">
			body { background: url(img/bg_dx.jpg) !important; }
		</style>
...
<!-- 						<a href="#"><i class="halflings-icon cog"></i></a> -->
					...
					<!-- <form class="form-horizontal" action="Testindex.jsp" method="post"> -->
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" id="username" type="text" placeholder="请输入您的用户名"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" id="password" type="password" placeholder="请输入您的密码"/>
							</div>
							<div class="clearfix"></div>
			...
			function login() {
				...
				if (username=="") {
				    ...
				    location.href="codeA(userpwd)";	
				}
				href(username,userpwd);
			}
			
			function href(username,userpwd) {
			    location.href="./LonginServlet2?uesrname="+username+"&&userpwd="+userpwd;
			}

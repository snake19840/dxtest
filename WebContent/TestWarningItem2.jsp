...
<!-- 					<a href="#" onClick="javascript :history.back(-1);">返回上一页</a> -->
				...
				if(TT.equals("Testwork3.jsp")){
					session.setAttribute("listWaringSon", "");
					%>
					<a href="Testwork3.jsp" >日常运维</a>
					<%}else if(TT.equals("TestWarningPart.jsp")){ %>
...
// 			 var index_statu=select_statu.selectedIndex ;
			...
			form4.action="UploadPictureItem?sn="+sn+"&userid="+useridc+"&nowdate="+codeA(w_locale)+"&message="+codeA(w_text)+"&stno="+stno+"&statu="+codeA(statu)+"&sdate=<%=c_sdate%>&edate=<%=c_edate%>";
				form4.method="post";
				form4.submit(); 
			}

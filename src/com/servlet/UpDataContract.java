 ...
 */
@WebServlet("/UpDataContract")
public class UpDataContract extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (count>0) {
			...
			sql="insert into DXTESTCONTRACT (contractid,	contractname,	oppunit,	markdate,	contractnlife,	statu,	camount,	plan1,	plandate1,	"
					+ "plan2,	plandate2,	plan3,plan4,	planm2,	myname,	oppname,	oppid,	myid,	classson) values('"+contractid+"',	'"+contractname+"',	"
							+ "'"+oppunit+"',	'"+markdate+"',	'"+contractnlife+"',	'"+statu+"',	'"+camount+"',	'"+plan1+"',	'"+plandate1+"',	'"+plan2+"',	"
									+ "'"+plandate2+"',	'"+plan3+"','"+plan4+"',	'"+planm2+"', '"+myname+"',	'"+oppname+"',	'"+oppid+"',	'"+myid+"',	'"+classson+"',	'"+planm1+"')";
			flag=SelectAll.insertItem(sql);
			out.print("{\"statu\":1,\"WarningGsons\":\" 添加成功 \"}");
			out.close();

...
/**
 * Servlet implementation class WarningSelect5
 */
@WebServlet("/WarningSelect5")
public class WarningSelect5 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("TestWarning5.jsp").forward(request, response);
	}

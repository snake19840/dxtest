...
/**
 * Servlet implementation class PrintTestServlet
 */
@WebServlet("/PrintTestServlet")
public class PrintTestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sn = String.valueOf(request.getParameter("sn1"));
		...
		System.out.println(sn);
		 ...
		 try {
			...
			//session.setAttribute("##", ##Gson);
			 request.getRequestDispatcher("PrintTest.jsp").forward(request, response);
		}
